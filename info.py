...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚠️ THIS FILE WILL BE DELETED IN 1 MIN FORWARD AND DOWNLOAD ⚠️\n\nҒILΣ🐙 : @sanusmovies _{file_name}\npowered by : @sanusmoviesch\nMade by : @cinema_kalavara\nReq group : @sanusmovies")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", None)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "THIS MESSAGE WILL BE DELETED IN 60 SECONDS\n\nʏᴏᴜʀ ϙᴜᴇʀʏ : {title}\nQᴜᴀʟɪᴛʏ : HD\nʀᴇϙᴜᴇsᴛᴇᴅ ʙʏ : {message.from_user.mention}\nᴜᴩʟᴏᴀᴅᴇᴅ ʙy : @sanusmoviesch\nrun by : @cinema_kalavara")
